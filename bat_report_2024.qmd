...
The 2024 City of Edmonton bat acoustic dataset gives a city-wide picture of where and when bats were active at the locations we monitored. We detected several bat species across the city, and their activity varied from place to place and over the course of each night. These results tell us how much bat activity a recorder picked up, not how many bats live in an area. The number of calls recorded at a site also depends on how long we recorded there, the weather, and how easy each species is to detect, since some bats call more often or more loudly than others. With those limits in mind, this dataset is a valuable starting point for tracking Edmonton's bats over time. Bats change their echolocation calls depending on their surroundings, what they're doing, and which stage of flight they're in, and some species make calls that sound very similar to one another. Because of this, recordings alone can't confirm with certainty which species were present, but they give us a solid basis for taking a closer look. A few things worth keeping in mind when looking at the results: A "detection" is a single recorded call sequence, not a single bat. One bat can create many detections, and many bats can fly past the same recorder. More detections mean more bat activity was recorded at that place and time. They don't tell us how large the population is. A very high number at one site might mean the recorder was near a roost or a route bats regularly use to travel. It doesn't necessarily mean there are lots of bats in the wider area, and a low number doesn't mean bats were absent. Each result reflects only the small area around a single recorder, not the average activity across a whole neighbourhood or region. Recorders were left out for different lengths of time. We account for this by measuring activity per night of recording, but results from sites with fewer recording nights are less certain.
...
Alberta Community Bat Program North American Bat Monitoring Program (NABat) Government of Alberta: Bat management
