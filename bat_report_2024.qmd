---
title: "Bat Monitoring: City of Edmonton 2024"
...
author: 
  ...
  - name: "Martin Hinojosa"
    affiliation:
      - "SENSR, Biodiversity Pathways Ltd."
  - name: "Cami Hurtado"
    affiliation:
      - "SENSR, Biodiversity Pathways Ltd."
editor: visual
...
![Big brown bat. Photo by Jason Headley.](Big%20Brown%20Bat.jpg){width="100%"}

::: {layout-ncol="2"}
![](SENSR_Logo_Left_Tagline_FullColour.png){width="70%" fig-align="center"}

![](cropped-university-logo.png){fig-align="center"}
:::

## Land Acknowledgement

Edmonton, ᐊᒥᐢᑿᒌᐚᐢᑲᐦᐃᑲᐣ Amiskwaciwâskahikan, is located within Treaty 6 Territory and within the Métis homelands and Métis Nation of Alberta Region 4. This land is part of the traditional territories of many First Nations such as the Nehiyaw (Cree), Denesuliné (Dene), Nakota Sioux (Stoney), Anishinaabe (Saulteaux) and Niitsitapi (Blackfoot). We acknowledge the traditional teachings of the lands that we work on, and that reciprocal, meaningful, and respectful relationships with Indigenous peoples make our work possible. We are deeply grateful for their stewardship of these lands, and we are committed to supporting Indigenous-led monitoring programs, while learning Indigenous ways of knowing, being, and doing.

## Bats in Alberta and Edmonton

Bats are an important part of healthy natural and urban ecosystems. Alberta’s bats are nocturnal insect-eaters that consume mosquitoes and insects that can damage forests and crops. By feeding on insects, they support food webs and provide ecological and economic benefits. Learn more by visiting the [Alberta Community Bat Program](https://www.albertabats.ca/)

Edmonton supports a network of urban natural areas, including the North Saskatchewan River valley, connected ravines, wetlands, parks, and developed neighbourhoods. The river valley and ravine system extends for more than 100 km and covers over 7,400 ha, forming one of North America’s largest continuous urban park networks (City of Edmonton (2024)). Together, these interconnected habitats provide bats with a range of foraging and roosting opportunities, including both natural features and human-made structures.

Eight bat species are estimated to occur in Edmonton (Bayne, unpublished data). These include resident and short-distance migratory species, such as little brown bat and big brown bat, as well as long-distance migrants such as hoary bat, eastern red bat, and silver-haired bat. Northern long-eared bat, a forest-associated species not typically linked with highly urbanized landscapes, has also been confirmed within the city (Cory Olson, Alberta Bats, pers. comm.). Little brown myotis and northern myotis are listed as endangered in Alberta, largely because of the threat posed by white-nose syndrome, a deadly fungal disease affecting hibernating bats in North America.

Urban bats may be affected by changes in habitat availability, loss of mature trees and roosting structures, artificial light at night, noise, and other human disturbances. Monitoring bats across Edmonton can therefore provide information on how different species use the city’s connected green spaces and help identify locations that support relatively high levels of activity.

Bats are difficult to monitor through direct observation because they are nocturnal and highly mobile. Autonomous recording units equipped with ultrasonic microphones provide a non-invasive way to monitor bats over extended periods. By recording echolocation calls across multiple nights, these units detect the presence, compare relative activity among locations, and examine temporal activity patterns. Passive acoustic monitoring is widely used in bat-monitoring programs, including the North American Bat Monitoring Program, which supports standardized and coordinated monitoring across North America (@Loeb2015NABatPlan).

## 2024 Bat Monitoring

During summer 2024, we launched a pilot study where community volunteers hosted ultrasonic bat detectors across Edmonton, St. Albert, and surrounding municipalities to contribute to what is known about urban bats in the region and determine whether a larger urban monitoring project would be feasible.

The results can guide future research into how noise, artificial light at night, habitat and urban green space affect bat activity and presence, and how cities can better protect bats. This report summarizes our findings after processing the acoustic data, including the number of detections, the species and species groups detected, and activity patterns through the night.

Although the project was not formally part of the North American Bat Monitoring Program, the study design and reporting approach follow a similar structure and provide a baseline for future bat monitoring in Edmonton.

## How Did We Do It?
![Anna Lenz and Autumn Kirk deploying a site in 2024.](2024_Bat_Fieldwork.png){width="100%"}
...
The separate protocol for the larger, multi-season study developed from this pilot is available on OSF: \[to be added after preregistration\].

The data, metadata, analytical R code, maps and report source are available on request.

## Want to learn more? Check these sites out!

[Alberta Community Bat Program](https://www.albertabats.ca) [North American Bat Monitoring Program (NABat)](https://www.nabatmonitoring.org/) [Government of Alberta: Bat management](https://www.alberta.ca/bat-management)

## Acknowledgements

These data were collected in coordination with many volunteers across the city of Edmonton, who generously lent us their time and allowed us onto their private property to collect bat data. We thank them for the opportunity and for their enthusiasm for urban bat monitoring. Coordination and data collection were led by Anna Lenz, who devoted considerable time to organizing the effort and connecting with volunteers.

SENSR (Services for Environmental Sensor Research; [sensr.ca](https://bp-sensr.github.io/coe-bats/sensr.ca)), a unit of Biodiversity Pathways ([biodiversitypathways.ca](https://bp-sensr.github.io/coe-bats/biodiversitypathways.ca)), compiled, processed, and worked alongside Anna Lenz to create this report.

Erin Bayne and Matina Kalcounis-Rueppell provided the funding sources \[insert funding\] that supported the original pilot project. Anna Lenz's PhD is currently supported by a Canada Excellence Research Chair Grant (no. ERC-2022-00074), under the supervision of Malgorzata Lagisz and Shinichi Nakagawa.
